...
//			"mq_message_history"
	...
	public static void main(String[] args) {
		...
		//生成路径
		gc.setOutputDir(System.getProperty("user.dir") + "/weixue-generator/src/main/java");
		gc.setAuthor("itcast");
		gc.setOpen(false);
		...
		dsc.setUrl("jdbc:mysql://192.168.101.65:3306/wx_" + SERVICE_NAME
